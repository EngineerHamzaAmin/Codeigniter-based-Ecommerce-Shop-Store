    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon white edit"></i><span class="break"></span>Offer Options</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <div class="row-fluid sortable">
                    ...
                    <a href="<?= base_url("homepage_blocks/deleteConf/$update_id")?>"><button type="button" class="btn btn-danger">Delete Offer Block</button></a>
                </div>
            </div>
