...
<head>
    ...
    <link id="ie-style" href="<?= base_url();?>adminfiles/css/ie.css" rel="stylesheet">
    <![endif]-->

    <!--[if IE 9]>
    <link id="ie9style" href="<?= base_url();?>adminfiles/css/ie9.css" rel="stylesheet">
    <![endif]-->
...
<?php
    if(isset($sort_this) && $sort_this == TRUE){
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown hidden-phone">
                        ...
                        <ul class="dropdown-menu messages">
                            ...
                            <li>
                                <a href="#">
                                    <span class="avatar"><img src="<?= base_url(); ?>adminfiles/img/avatar.jpg"
                                                              alt="Avatar"></span>
                                    <span class="header">
											<span class="from">
										    	Dennis Ji
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    <li><a href="<?= base_url('dashboard/home') ?>"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a>
                    </li>

                    <?php echo Modules::run('store_order_status/_draw_left_nav_links')?>

                    <li><a href="<?= base_url('sliders/manage') ?>"><i class="icon-picture"></i><span class="hidden-tablet"> Manage Slider(s)</span></a>
                    </li>

<li><a href="<?= base_url('store_order_status/manage') ?>"><i class="icon-file-alt"></i><span class="hidden-tablet"> Order Status Options</span></a>
                    </li>
                    ...
                    <li><a href="<?= base_url('enquiries/inbox') ?>"><i class="icon-envelope"></i><span
                                    class="hidden-tablet"> Messages</span></a></li>

                    <li><a href="<?= base_url("store_accounts/manage") ?>"><i class="icon-briefcase"></i><span
                                    class="hidden-tablet">Accounts</span></a></li>
                </ul>
            </div>
        </div>
        <!-- end: Main Menu -->
