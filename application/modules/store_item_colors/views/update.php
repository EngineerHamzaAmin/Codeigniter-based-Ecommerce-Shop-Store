...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon white edit"></i><span class="break"></span>Item Colors Options</h2>
            <div class="box-icon">
            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                ?>
                    <tr>
                        ...
                        <td class="center">
                            <a class="btn btn-danger" href="<?= base_url("store_item_colors/delete/$row->id");?>">Remove Option
