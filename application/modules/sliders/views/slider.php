...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin-top: 24px;">
    ...
    <ol class="carousel-indicators">
        <?php
            ...
            foreach($query_slides->result() as $row_slides):
                if($count==0){
                    $additional_class = ' class="active"';
                } else {
                    $additional_class = '';
                }
        ?>
        <li data-target="#carousel-example-generic" data-slide-to="<?= $count ?>" <?= $additional_class ?>></li>
        <?php
            $count++;
            endforeach;
        ?>
    ...
    <div class="carousel-inner" role="listbox">
        ...
        foreach($query_slides->result() as $row):
            ...
            if($count==0){
                $additional_class = ' class="item active"';
            } else {
                $additional_class = ' class="item"';
            }
            if(!isset($alt_text)){
                $alt_text = '...';
            }
