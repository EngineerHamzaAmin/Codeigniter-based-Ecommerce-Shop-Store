...
class Sliders extends MX_Controller
{
    ...
    function delete($update_id){
        ...
        if($submit=="Cancel"){
            ...
            $flash_msg='Slider Has Been Deleted  Successfully';
    ...
    function _process_delete($update_id){
        //Delete any items associated with slide block
        $this->load->module('slides');
        ...
        if ($submit == 'Submit') {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                if (is_numeric($update_id)) {
                    //update records
                    $this->_update($update_id, $data);
                    $flash_msg = 'Slider details Updated Successfully';
                    ...
                    $flash_msg = 'Slider added Successfully';
                    $value = "<div class='alert alert-success' role='alert'>" . $flash_msg . "</div>";
                    $this->session->set_flashdata('item', $value);
                    redirect("sliders/create/$update_id");
                }
