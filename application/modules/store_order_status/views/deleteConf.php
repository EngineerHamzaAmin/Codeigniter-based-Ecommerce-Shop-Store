...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
         <?php echo form_open('store_order_status/delete/'.$update_id,["class"=>"form-horizontal"]);?>
            <p style="margin-top: 20px;">Please confirm if you really want to delete the Order Status Option</p>
            <fieldset>
